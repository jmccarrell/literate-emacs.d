...
** gptel
   ...
   First landing: a plain chat client with one cloud backend.  Keep
   local models, tools, MCP, agentic editing, and inline completion as
   separate follow-up sub-goals.

...
*** Steps to Reproduce
    ...
    4. Expected vs Actual Results
       ...
       - To see this, execute =ivy-switch-buffer=, ie, =C-x b=
         - I only see three buffers:
           - =*scratch*=
           - =*Messages*=
           - =counsel.el=
       - Run =M-x list-buffers=.  Here are the results I see:
       #+BEGIN_EXAMPLE
       .   counsel.el           228097 Emacs-Lisp       ~/.emacs.d/elpa/counsel-20190803.1121/counsel.el
         * *scratch*               475 Lisp Interaction

...
** gptel
   ...
   first local follow-up registers a single Ollama-backed Gemma 4
   model, while keeping tools, MCP, agentic editing, and inline
   completion as separate follow-up sub-goals.
